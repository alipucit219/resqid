...
const ClientUpdatesCard = () => {
  const data = dashboardDummyData.clientUpdates
      ...
      <CardHeader
        title={
          <Box sx={{ display: 'flex', alignItems: 'center', '& svg': { mr: 3 } }}>
            ...
            <Typography>Client Updates</Typography>
          </Box>
        }
      />
                ...
                <Box sx={{ mb: 0.5, display: 'flex', flexWrap: 'wrap', justifyContent: 'space-between' }}>
                  <Box sx={{ display: 'flex', alignItems: 'center' }}>
                    ...
                    <Box sx={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-start' }}>
                      <Typography sx={{ fontWeight: 500 }}>{item?.client?.name}</Typography>
...
export default ClientUpdatesCard
